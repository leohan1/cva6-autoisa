...
module autoisa_ci_inflight_table #(
  ...
  assign completion_killed = kill_valid_i && kill_found && completion_found &&
  ...
  always_comb begin
    ...
    if (complete_fire && completion_found && !completion_killed) begin
  ...
  always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
      ...
      if (flush_i) killed_count_o <= killed_count_o + occupancy_o;
