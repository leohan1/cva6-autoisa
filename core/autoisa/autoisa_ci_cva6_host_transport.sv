...
module autoisa_ci_cva6_host_transport #(
  ...
  assign adapter_commit_id_in_range = !(|adapter_commit_tag[AUTOISA_TAG_WIDTH-1:TRANS_ID_WIDTH]);
  assign adapter_kill_id_in_range = !(|adapter_kill_tag[AUTOISA_TAG_WIDTH-1:TRANS_ID_WIDTH]);
  ...
  assign shell_commit_valid = commit_matches_allocated || commit_matches_req || pending_matches_req;
  always_comb begin
  ...
  autoisa_ci_cva6_host_adapter #(
      ...
      .issue_trans_id_i(issue_trans_id_i),
      .issue_accept_o(issue_accept_o),
      .issue_recognized_o(issue_recognized_o),
      .issue_illegal_o(issue_illegal_o),
      .issue_identity_busy_o(),
      .issue_raw_hazard_o(),
      .issue_waw_hazard_o(),
      .issue_desc_valid_o(host_desc_valid),
      .issue_desc_ready_i(host_desc_ready),
      .issue_desc_o(host_desc),
      .commit_valid_i(commit_valid_i),
      .commit_trans_id_i(commit_trans_id_i),
      .commit_kill_i(commit_kill_i),
      .commit_identity_hit_o(commit_identity_hit_o),
      .shell_commit_valid_o(adapter_commit_valid),
      .shell_commit_tag_o(adapter_commit_tag),
      .shell_commit_epoch_o(adapter_commit_epoch),
      .shell_kill_valid_o(adapter_kill_valid),
      .shell_kill_tag_o(adapter_kill_tag),
      .shell_kill_epoch_o(adapter_kill_epoch),
      .shell_flush_o(),
      ...
      .destination_high_watermark_o(),
      .issue_accept_count_o(),
      .issue_reject_count_o(),
      .stale_result_drop_count_o(),
      .unknown_commit_count_o()
  );

  autoisa_ci_operand_gather #(
      .PENDING_DEPTH(GATHER_DEPTH),
      .COUNT_WIDTH  (COUNT_WIDTH)
  ) i_operand_gather (
      .clk_i(clk_i),
      .rst_ni(rst_ni),
      .flush_i(flush_i),
      .desc_valid_i(host_desc_valid),
      .desc_ready_o(host_desc_ready),
      .desc_i(host_desc),
      .desc_illegal_o(),
      .rf_req_valid_o(rf_req_valid_o),
      .rf_req_ready_i(rf_req_ready_i),
      .rf_lane_valid_o(rf_lane_valid_o),
      .rf_addr_o(rf_addr_o),
      .rf_data_i(rf_data_i),
      .req_valid_o(shell_req_valid),
      .req_ready_i(shell_req_ready),
      .req_o(shell_req),
      .kill_valid_i(adapter_kill_valid),
      .kill_tag_i(adapter_kill_tag),
      .kill_epoch_i(adapter_kill_epoch),
      .kill_hit_o(),
      .occupancy_o(gather_occupancy_o),
      .high_watermark_o(),
      .accepted_count_o(),
      .emitted_count_o(),
      .gather_beat_count_o(),
  ...
  autoisa_ci_concurrent_shell #(
      ...
      .rst_ni(rst_ni),
      .flush_i(flush_i),
      .req_valid_i(shell_req_valid),
      .req_ready_o(shell_req_ready),
      .req_i(shell_req),
      .req_duplicate_o(),
      .commit_valid_i(shell_commit_valid),
      .commit_tag_i(shell_commit_tag),
      ...
      .result_ready_i(shell_result_ready),
      .result_o(shell_result),
      .request_occupancy_o(),
      .request_high_watermark_o(),
      .inflight_occupancy_o(),
      .inflight_high_watermark_o(),
      .result_occupancy_o(),
      .result_high_watermark_o(),
      .reserved_result_credits_o(),
      .credit_high_watermark_o(),
      .engine_skid_occupancy_o(),
      .engine_skid_high_watermark_o(),
      .accepted_count_o(shell_accepted_count_o),
      .dispatched_count_o(),
      .engine_started_count_o(),
      .completion_count_o(),
      .retired_count_o(shell_retired_count_o),
      .killed_count_o(),
      .orphan_completion_count_o(),
      .tombstone_drop_count_o(),
      .credit_stall_count_o(),
      .result_full_stall_count_o(),
      .result_flush_drop_count_o(),
      .skid_killed_drop_count_o(),
  ...
  autoisa_ci_pair_writeback_serializer #(
      ...
      .rst_ni(rst_ni),
      .flush_i(flush_i),
      .result_valid_i(host_result_valid),
      .result_ready_o(host_result_ready),
      .result_trans_id_i(host_result_trans_id),
      .result_dst_valid_i(host_result_dst_valid),
      .result_dst_addr_i(host_result_dst_addr),
      .result_data_i(host_result_data),
      .result_write_policy_i(host_result_write_policy),
      .result_status_i(host_result_status),
      .wb_valid_o(wb_valid_o),
      .wb_ready_i(wb_ready_i),
      .wb_trans_id_o(wb_trans_id_o),
      .wb_addr_o(wb_addr_o),
      .wb_data_o(wb_data_o),
      .wb_we_o(wb_we_o),
      .wb_last_o(wb_last_o),
      .wb_status_o(wb_status_o),
      .pair_second_pending_o(),
      .result_count_o(wb_result_count_o),
  ...
  always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
      ...
      if (shell_req_fire) begin
        ...
        if (pending_matches_req) commit_pending_q[req_id] <= 1'b0;
      end
