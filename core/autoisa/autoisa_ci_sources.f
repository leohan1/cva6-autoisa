# Canonical AutoISA Compute-only CI production source order (ABI v1.0).
# Paths are repository-root relative. Testbenches are intentionally excluded.
core/autoisa/autoisa_ci_types_pkg.sv
core/autoisa/autoisa_ci_layout_decoder.sv
core/autoisa/autoisa_ci_layout_decoder_v2.sv
core/autoisa/autoisa_ci_destination_map.sv
core/autoisa/autoisa_ci_cva6_decode_adapter.sv
...
core/autoisa/autoisa_h1_pair_load.sv
core/autoisa/autoisa_ci_harness_v0.sv
