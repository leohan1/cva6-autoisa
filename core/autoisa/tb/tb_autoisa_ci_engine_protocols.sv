...
module tb_autoisa_ci_engine_protocols;
  ...
  task automatic run_and_expect(input logic [3:0] tag, input logic [7:0] ci_id,
                                input logic [31:0] operand0, input logic [31:0] operand1,
                                input logic [31:0] expected_value,
                                input autoisa_ci_status_e expected_status,
                                input logic [1:0] expected_mask, input integer expected_latency);
    ...
    begin
      ...
      if (observed_latency != expected_latency)
        $fatal(
            1,
            "latency mismatch ci=%0d expected=%0d got=%0d",
            ci_id,
            expected_latency,
            observed_latency
        );
  ...
  initial begin
    ...
    run_and_expect(4'd1, 8'd8, 32'd0, 32'd10, 32'd10, AUTOISA_STATUS_OK, 2'b01, 1);
    run_and_expect(4'd2, 8'd8, 32'd7, 32'd10, 32'd17, AUTOISA_STATUS_OK, 2'b01, 8);
    ...
    run_and_expect(4'd4, 8'd11, 32'd0, 32'd0, 32'd0, AUTOISA_STATUS_ENGINE_FAULT, 2'b00, 1);
